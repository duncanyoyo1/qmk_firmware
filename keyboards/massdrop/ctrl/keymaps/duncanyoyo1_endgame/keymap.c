...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_KL] = LAYOUT(
        ...
        LM(_CL, MOD_LSFT), KC_Z,           KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,                                KC_UP,
        TD(TD_CTRL_TERM),  TD(TD_LGUI_ML), KC_LALT,                   KC_SPC,                             LM(_NL, MOD_RALT), TT(_FL), TD(TD_APP_YL), KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FL] = LAYOUT(
    ...
    [_NL] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______,
        KC_NLCK, KC_P1,   KC_P2,   KC_P3,     KC_P4,   KC_P5,   KC_P6,   KC_P7,   KC_P8,   KC_P9,   KC_P0, KC_PMNS, KC_PPLS, KC_BSPC,   _______, _______, _______,
...
const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    ...
    [_CL] = {
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
            RED, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                            _______,
        _______, _______, _______,                   _______,                            _______, _______, _______, _______,          _______, _______, _______
    },
    [_NL] = {
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______,
           BLUE,     RED,     RED,     RED,     RED,     RED,     RED,     RED,     RED,     RED,     RED,   GREEN,   GREEN,     RED, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,     RED,     RED,     RED, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,     RED,     RED,     RED, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,     RED, _______,     RED, _______, _______,                            _______,
        _______, _______, _______,                   _______,                            _______, _______, _______, _______,          _______, _______, _______
    },
};
