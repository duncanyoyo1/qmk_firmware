...
enum layout_names {
    ...
    _CL,         // Caps Lock is awful, but just in case you need it, it's there.
    _NL,         // Num Lock is needed sometimes on TLK boards, especially for games that expect you to have a numpad with no option to remap.
};
